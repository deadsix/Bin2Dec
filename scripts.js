...
function checkIfBinary(keyPressed){
    if(keyPressed.key != '0' && keyPressed.key != '1' && keyPressed.key != 'Delete' && keyPressed.key != 'ArrowLeft'&& keyPressed.key != 'ArrowRight'&& keyPressed.key != 'ArrowUp'&& keyPressed.key != 'ArrowDown'&& keyPressed.key != 'Tab' ){
